...
export type ToggleButtonGroupSlotsAndSlotProps = CreateSlotsAndSlotProps<ToggleButtonGroupSlots, {
...
export interface ToggleButtonGroupOwnProps<TValue extends SupportedValue> extends ToggleButtonGroupStaticProps {
    /**
     ...
     */
    onChange?: (event: React.MouseEvent<HTMLElement>, value: TValue extends Array<infer U> ? Array<U> : TValue | null) => void;
}
export interface ToggleButtonGroupTypeMap<TValue extends SupportedValue, P = {}, D extends React.ElementType = 'div'> {
    props: P & ToggleButtonGroupOwnProps<TValue> & ToggleButtonGroupSlotsAndSlotProps;
    defaultComponent: D;
}
export type ToggleButtonGroupProps<TValue extends SupportedValue, D extends React.ElementType = ToggleButtonGroupTypeMap<TValue>['defaultComponent'], P = {
    component?: React.ElementType;
}> = OverrideProps<ToggleButtonGroupTypeMap<TValue, P, D>, D>;
export interface ToggleButtonGroupOwnerState<TValue extends SupportedValue> extends ApplyColorInversion<ToggleButtonGroupProps<TValue>> {
}
export {};
